...
INSERT INTO AC_INFO VALUES('110-003',100000,1);

INSERT INTO USER_AC VALUES(20501,'110-001');
INSERT INTO USER_AC VALUES(20502,'110-002');
INSERT INTO USER_AC VALUES(20501,'110-003');

INSERT INTO AC_TRADE VALUES((select nvl(max(TRANSACTION_NUMBER),0) + 1 from AC_TRADE),'110-001','110-002',TO_CHAR(SYSDATE,'YYYY/MM/DD HH24:MI:SS'),5000,1);
